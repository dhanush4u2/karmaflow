...
export function Reporting() {
  const { summary, loading: summaryLoading, error: summaryError } = useReportSummary();
  // We need to fetch all the raw data for the PDF
  ...
  const handleGenerateReport = async () => {
    // Ensure all data is loaded before generating
    ...
    try {
      // Pass all the fetched data to the PDF generation utility
